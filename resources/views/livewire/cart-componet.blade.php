<div class="container">
    ...
    <div class=" main-content-area">
                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="product-name">
                                <a class="link-to-product"
                                    href="{{ route('details', ['slug' => $item->model->slug]) }}">{{ $item->model->name }}</a>
                            </div>
                            ...
                            <div class="quantity">
                                <div class="quantity-input">
                                    ...
                                    <a class="btn btn-increase" href="#"
                                        wire:click.prevent="increareItem('{{ $item->rowId }}')"></a>
                                    <a class="btn btn-reduce" href="#"
                                        wire:click.prevent="decreareItem('{{ $item->rowId }}')"></a>
                                </div>
                            </div>
        ...
        <div class="summary">
            ...
            <div class="update-clear" style="display: block">
                <a class="btn btn-clear " href="#" wire:click.prevent="removeAll()">Clear Shopping
                    Cart</a>
            </div>
        </div>
                    ...
                    @foreach ($most_products as $most_product)
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="{{ route('details', ['slug' => $most_product->slug]) }}"
                                    title="{{ $most_product->slug }}">
                                    <figure><img src="{{ asset('assets/images/products/' . $most_product->image) }}"
                                            width="214" height="214" alt="{{ $most_product->slug }}">
                                    </figure>
                                </a>
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>{{ $most_product->name }}</span></a>
                                <div class="wrap-price"><span
                                        class="product-price">${{ $most_product->regular_price }}</span></div>
                            </div>
                        </div>
                    @endforeach
