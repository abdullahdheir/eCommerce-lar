            ...
            @foreach ($products as $product)
                <div class="product product-style-2 equal-elem ">
                    <div class="product-thumnail">
                        <a href="{{ route('details', ['slug' => $product->slug]) }}" title="{{ $product->slug }}">
                ...
                <div class="tab-contents">
                    <div class="tab-content-item active" id="digital_1a">
                        <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                            ...
                            @foreach ($laset_products as $l_product)
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('details', ['slug' => $l_product->slug]) }}"
                                            title="{{ $l_product->slug }}">
                                            <figure><img
                                                    src="{{ asset('assets/images/products/' . $l_product->image) }}"
                                                    width="800" height="800" alt="{{ $l_product->name }}">
                                            </figure>
                                        </a>
                                        <div class="group-flash">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span
                                                class="product-price">${{ $l_product->regular_price }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
