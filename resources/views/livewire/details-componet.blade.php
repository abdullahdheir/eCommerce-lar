<div class="container">
    <div class="wrap-breadcrumb">
        <ul>
            ...
            <li class="item-link"><span>{{ $d_product->name }}</span></li>
        </ul>
    </div>
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
            <div class="wrap-product-detail">
                <div class="detail-media">
                    <div class="product-gallery">
                        <ul class="slides">
                            ...
                            <li data-thumb="{{ asset('assets/images/products/' . $d_product->image) }}">
                                <img src="{{ asset('assets/images/products/' . $d_product->image) }}"
                ...
                <div class="detail-info">
                    ...
                    <h2 class="product-name">{{ $d_product->name }}</h2>
                    ...
                    <div class="wrap-social">
                        <a class="link-socail" href="#"><img
                                src="{{ asset('assets/images/' . $d_product->image) }}" alt=""></a>
                    </div>
                    ...
                    <div class="quantity">
                        ...
                        <div class="quantity-input">
                            <input type="text" name="product-quatity" id="product-quatity" value="{{ $product_qty }}"
                    ...
                    <div class="wrap-butons">
                        <a href="#" class="btn add-to-cart"
                            wire:click.prevent="store('{{ $d_product->id }}','{{ $d_product->name }}','{{ $d_product->regular_price }}')">Add
                            to Cart</a>
                        <div class="wrap-btn">
                        ...
                        @foreach ($related_products as $related_product)
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="{{ route('details', ['slug' => $related_product->slug]) }}"
